 ...
 * 10.03.2023:
 * @TODO
 *   в add, update, add_if_max, remove_lower используется один и тот же большой кусок кода... но как мы будем возвращать полученные значения, если они все разной природы?
